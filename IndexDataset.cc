...
void IndexDataset::parseText(string& contents, unsigned int key, Index* index)
{
	// trim leading spaces
...
void IndexDataset::appendAttributes(string& str, Json::Value& attributes)
{
...
void IndexDataset::appendCategories(string& str, Json::Value& categories)
{
...
void IndexDataset::createTermIndex(string path, Index* index, map<unsigned int, Document>& docMap){
...
void IndexDataset::readStopList(string stopListPath) {
	string word;
...
void IndexDataset::writeFile(map<string, Lexicon>& lexicon, map<unsigned int, Document>& docMap,
        string lexiconFilePath, string invlistsFilePath, string docMapFilePath) {
	/*string lexiconFilePath("./output/lexicon");
	string invlistsFilePath("./output/ivlist");
	string docMapFilePath("./output/map");*/
...
/*int main()
{
	string stopListPath = "./input/stop-words_english_6_en.txt";
